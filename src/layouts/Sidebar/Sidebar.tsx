...
const Sidebar = () => {
    ...
    return <div className="xl:rounded-3xl sm:rounded-none lg:h-auto lg:min-w-[156px] bg-white dark:bg-spaceCadet-900">
        <nav className="p-1 md:p-5">
            <ul className={`xl:space-y-3 sm:space-x-3 xl:space-x-0 flex xl:flex-col sm:justify-between gap-3 overflow-x-auto`}>
                ...
                <li className="text-center flex space-x-2 justify-center items-center bg-transparent px-2">
                    <DarkThemeToggle
